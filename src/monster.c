...
static const Monster monsters[] = {
    { HORSE1_TILE,      UNKNOWN,       "Horse",        9,  0, 0 },
    { HORSE2_TILE,      UNKNOWN,       "Horse",        9,  0, 0 },
 
    { MAGE_TILE,        UNKNOWN,       "Mage",         8,  MAGICFLASH_TILE, 0 },
    { BARD_TILE,        UNKNOWN,       "Bard",         9,  0, 0 },
    { FIGHTER_TILE,     UNKNOWN,       "Fighter",      7,  0, 0 },
    { DRUID_TILE,       UNKNOWN,       "Druid",        10, 0, 0 },
    { TINKER_TILE,      UNKNOWN,       "Tinker",       9,  0, 0 },
    { PALADIN_TILE,     UNKNOWN,       "Paladin",      4,  0, 0 },
    { RANGER_TILE,      UNKNOWN,       "Ranger",       3,  0, 0 },
    { SHEPHERD_TILE,    UNKNOWN,       "Shepherd",     9,  0, 0 },

    { GUARD_TILE,       UNKNOWN,       "Guard",        13, 0, 0 },
    { VILLAGER_TILE,    UNKNOWN,       "Villager",     13, 0, 0 },
    { SINGINGBARD_TILE, UNKNOWN,       "Bard",         9,  0, 0 },
    { JESTER_TILE,      UNKNOWN,       "Jester",       9,  0, 0 },
    { BEGGAR_TILE,      UNKNOWN,       "Beggar",       13, 0, 0 },
    { CHILD_TILE,       UNKNOWN,       "Child",        10, 0, 0 },
    { BULL_TILE,        UNKNOWN,       "Bull",         11, 0, 0 },
    { LORDBRITISH_TILE, UNKNOWN,       "Lord British", 16, MAGICFLASH_TILE, 0 },
    ...
    { WHIRLPOOL_TILE,   WHIRLPOOL_TILE, "Whirlpool",   16, 0,      MATTR_WATER | MATTR_NONATTACKABLE },
    { STORM_TILE,       STORM_TILE,    "Storm",        16, 0,      MATTR_WATER | MATTR_NONATTACKABLE },
    { RAT_TILE,         SKELETON_TILE, "Rat",          3,  0,      MATTR_GOOD },
    { BAT_TILE,         LAVA_LIZARD_TILE, "Bat",       3,  0,      MATTR_GOOD },
    { GIANT_SPIDER_TILE, RAT_TILE,     "Giant Spider", 4,  POISONFIELD_TILE, MATTR_GOOD },
    ...
    { INSECT_SWARM_TILE, RAT_TILE,     "Insect Swarm", 3,  0,      MATTR_GOOD },
    ...
    { PYTHON_TILE,      RAT_TILE,      "Python",       3,  POISONFIELD_TILE, MATTR_GOOD },
