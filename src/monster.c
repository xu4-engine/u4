...
static const Monster monsters[] = {
    ...
    { GIANT_SQUID_TILE, SEA_SERPENT_TILE, "Giant Squid",  6,  0 },
    { SEA_SERPENT_TILE, GIANT_SQUID_TILE, "Sea Serpent",  8,  0 },
    { SEAHORSE_TILE,    NIXIE_TILE,    "Seahorse",     6,  MATTR_GOOD },
    { WHIRLPOOL_TILE,   WHIRLPOOL_TILE, "Whirlpool",   16, 0 },
    { STORM_TILE,       STORM_TILE,    "Storm",        16, 0 },
