...
static const Monster monsters[] = {
    ...
    { WHIRLPOOL_TILE,   WHIRLPOOL_TILE, "Whirlpool",   16, MATTR_WATER | MATTR_NONATTACKABLE },
    { STORM_TILE,       STORM_TILE,    "Storm",        16, MATTR_WATER | MATTR_NONATTACKABLE },
    ...
    { MIMIC_TILE,       MIMIC_TILE,    "Mimic",        12, MATTR_STATIONARY },
    { REAPER_TILE,      REAPER_TILE,   "Reaper",       16, MATTR_CASTS_SLEEP | MATTR_STATIONARY },
