...
static const Monster monsters[] = {
    ...
    { SEAHORSE_TILE,    UNKNOWN,       "Seahorse",     7,  0 },
    { WHIRLPOOL_TILE,   UNKNOWN,       "Whirlpool",    UNKNOWN, 0 },
    { STORM_TILE,       UNKNOWN,       "Storm",        UNKNOWN, 0 },
    { RAT_TILE,         UNKNOWN,       "Rat",          3,  0 },
    { BAT_TILE,         UNKNOWN,       "Bat",          3,  0 },
    { GIANT_SPIDER_TILE, UNKNOWN,      "Giant Spider", 4,  0 },
    { GHOST_TILE,       UNKNOWN,       "Ghost",        5,  0 },
    { SLIME_TILE,       UNKNOWN,       "Slime",        3,  0 },
    { TROLL_TILE,       ETTIN_TILE,    "Troll",        6,  0 },
    { GREMLIN_TILE,     UNKNOWN,       "Gremlin",      3,  ATTACKMOD_STEALFOOD },
    { MIMIC_TILE,       UNKNOWN,       "Mimic",        12, 0 },
    { REAPER_TILE,      UNKNOWN,       "Reaper",       16, 0 },
    { INSECT_SWARM_TILE, UNKNOWN,      "Insect Swarm", 3,  0 },
    { GAZER_TILE,       UNKNOWN,       "Gazer",        15, 0 },
    { PHANTOM_TILE,     UNKNOWN,       "Phantom",      8,  0 },
    { ORC_TILE,         TROLL_TILE,    "Orc",          5,  0 },
    { SKELETON_TILE,    EVILMAGE_TILE, "Skeleton",     3,  0 },
    { ROGUE_TILE,       UNKNOWN,       "Rogue",        5,  ATTACKMOD_STEALGOLD },
    { PYTHON_TILE,      UNKNOWN,       "Python",       3,  0 },
    ...
    { BALRON_TILE,      UNKNOWN,       "Balron",       16, 0 }
};
