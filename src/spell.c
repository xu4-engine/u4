...
const Spell spells[] = {
    { "Awaken",       GINSENG | GARLIC,        SC_ANY,     SPELLPRM_PLAYER,  5 },
    { "Blink",        SILK | MOSS,             SC_NORMAL,  SPELLPRM_DIR,     15 },
    { "Cure",         GINSENG | GARLIC,        SC_ANY,     SPELLPRM_PLAYER,  5 },
    { "Dispel",       ASH | GARLIC | PEARL,    SC_ANY,     SPELLPRM_DIR,     20 },
    { "Energy Field", ASH | SILK | PEARL,      SC_ANY,     SPELLPRM_DIR,     10 },
    { "Fireball",     ASH | PEARL,             SC_COMBAT,  SPELLPRM_DIR,     15 },
    { "Gate",         ASH | PEARL | MANDRAKE,  SC_NORMAL,  SPELLPRM_PHASE,   40 },
    { "Heal",         GINSENG | SILK,          SC_ANY,     SPELLPRM_PLAYER,  10 },
    { "Iceball",      PEARL | MANDRAKE,        SC_COMBAT,  SPELLPRM_DIR,     20 },
    { "Jinx",         PEARL | NIGHTSHADE | MANDRAKE, SC_COMBAT, SPELLPRM_NONE, 30 },
    { "Kill",         PEARL | NIGHTSHADE,      SC_COMBAT,  SPELLPRM_DIR,     25 },
    { "Light",        ASH,                     SC_DUNGEON, SPELLPRM_NONE,    5 },
    { "Magic missile", ASH | PEARL,            SC_COMBAT,  SPELLPRM_DIR,     5 },
    { "Negate",       ASH | GARLIC | MANDRAKE, SC_COMBAT,  SPELLPRM_NONE,  20 },
    { "Open",         ASH | MOSS,              SC_NORMAL,  SPELLPRM_NONE,  5 },
    { "Protection",   ASH | GINSENG | GARLIC,  SC_ANY,     SPELLPRM_NONE,  15 },
    { "Quickness",    ASH | GINSENG | MOSS,    SC_ANY,     SPELLPRM_NONE,  20 },
    { "Resurrect",    ASH | GINSENG | GARLIC | SILK | MOSS | MANDRAKE, SC_ANY, SPELLPRM_PLAYER, 45 },
    { "Sleep",        SILK | GINSENG,          SC_COMBAT,  SPELLPRM_NONE,  15 },
    { "Tremor",       ASH | MOSS | MANDRAKE,   SC_COMBAT,  SPELLPRM_NONE,  30 },
    { "Undead",       ASH | GARLIC,            SC_ANY,     SPELLPRM_NONE,  15 },
    { "View",         NIGHTSHADE | MANDRAKE,   SC_NORMAL | SC_DUNGEON, SPELLPRM_NONE, 15 },
    { "Winds",        ASH | MOSS,              SC_NORMAL,  SPELLPRM_FROMDIR, 10 },
    { "X-it",         ASH | SILK | MOSS,       SC_DUNGEON, SPELLPRM_NONE,  15 },
    { "Y-up",         SILK | MOSS,             SC_DUNGEON, SPELLPRM_NONE,  10 },
    { "Z-down",       SILK | MOSS,             SC_DUNGEON, SPELLPRM_NONE,  5 }
};
