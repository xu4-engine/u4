...
void Shrine::enter() {
    ...
    if (settings.enhancements && settings.enhancementsOptions.u5shrines) {
        ...
        annotations->add(Coords(5, 6, c->location->coords.z), Tile::get(GRASS_TILE)->id, true);
