...
tileset: [
    ...
    (name: forest rule: brush opaque: true)
    (name: hills rule: hills)
    (name: mountains rule: mountains opaque: true)
    (name: dungeon)
    ...
    (name: waterside_sw rule: solid_attackover usesReplacementTileAsBackground: true usesWaterReplacementTileAsBackground: true)
    (name: waterside_se rule: solid_attackover usesReplacementTileAsBackground: true usesWaterReplacementTileAsBackground: true)
    (name: waterside_nw rule: solid_attackover usesReplacementTileAsBackground: true usesWaterReplacementTileAsBackground: true)
    (name: waterside_ne rule: solid_attackover usesReplacementTileAsBackground: true usesWaterReplacementTileAsBackground: true)
    ...
    (name: secret_door rule: secret_door opaque: true)
    ...
    (name: brick_wall rule: walls opaque: true)
