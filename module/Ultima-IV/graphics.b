...
imageset EGA [
    ...
    image (name: honesty filename: "u4/honesty.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: compassn filename: "u4/compassn.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: valor filename: "u4/valor.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: justice filename: "u4/justice.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: sacrific filename: "u4/sacrific.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: honor filename: "u4/honor.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: spirit filename: "u4/spirit.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: humility filename: "u4/humility.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
    image (name: truth filename: "u4/truth.ega" width: 320 height: 200 depth: 4 filetype: u4rle fixup: transparent0)
